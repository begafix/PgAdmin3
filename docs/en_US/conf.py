...
project = u'pgAdmin III'
copyright = u'2002 - 2016, The pgAdmin Development Team'
...
latex_documents = [
  ('index', 'pgadmin3.tex', u'pgAdmin III Documentation',
...
man_pages = [
    ('index', 'pgadmin3', u'pgAdmin III Documentation',
