...
const short SERVER_MIN_VERSION_N = 0x0906;
const wxString SERVER_MIN_VERSION_T = wxT("9.6");
const short SERVER_MAX_VERSION_N = 0x1402;
const wxString SERVER_MAX_VERSION_T = wxT("14.2");
