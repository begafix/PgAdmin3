...
wxString pgAdmin3::LocatePath(const wxString &pathToFind, const bool isFile)
{
	...
	if (!isFile)
	{
		...
		else if (wxDir::Exists(loadPath + wxT("/../pgAdmin3") + pathToFind))
			return sanitizePath(loadPath + wxT("/../pgAdmin3") + pathToFind);
	...
	else
	{
		if (wxFile::Exists(loadPath + pathToFind))
			return sanitizePath(loadPath + pathToFind);
		else if (wxFile::Exists(loadPath + wxT("/../pgAdmin3") + pathToFind))
			return sanitizePath(loadPath + wxT("/../pgAdmin3") + pathToFind);
